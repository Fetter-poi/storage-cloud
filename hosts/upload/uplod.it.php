...
/* # Plugin's Settings # */
$_T8['domain'] = 'uplod.it'; // May require the www. (Check first if the site adds the www.).
...
/* # Account Info # */
$upload_acc[$acc_key_name]['user'] = 'uploads@emmm.anyalias.com'; //Set your login
$upload_acc[$acc_key_name]['pass'] = 'uploads'; //Set your password
